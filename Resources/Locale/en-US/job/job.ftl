job-greet-station-name = Welcome to {$stationName}.
...
job-greet-crew-shortages = This prison was built for a larger population. More newcomers can join at any time.
...
job-greet-inmate-introduce-job-name = You are an Inmate. You ride with [color=#746694]{ THE($car) }[/color].
job-greet-inmate-warning = Careful! There are both Guard Rules and Car Rules.
    Don't Get Stabbed!
